  ...
  return (
    ...
    >
      ...
      <p className="mb-8 mt-3 max-w-2xl text-sm text-muted-foreground">
        Retrieves interview and filing passages separately - for one company, or
        across every company you may read - then asks for a grounded verdict on
        how the two sides relate. Every claim below cites the exact passage it
        read.
      </p>
