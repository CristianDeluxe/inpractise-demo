...
export const buildTimelineThemes = {
  ...
  '2026-09-16-am':
    'A bounded Investigate agent and a cross-reference Compare workspace joined Ask, both wired through the browser client. Query embeddings were cached and independent research work overlapped, with per-phase server timing surfaced in the UI, and a research notebook was added to hold findings across turns. The Rolls-Royce Holdings annual report was ingested as a PDF filing, and the public landing and built-with-agents pages were rebuilt.',
