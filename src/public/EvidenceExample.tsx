...
export function EvidenceExample() {
  return (
    <section
      id="evidence"
      className="page-shell grid gap-12 py-20 lg:grid-cols-12"
    >
      <div className="lg:col-span-5">
        ...
        <p className="mt-5 text-sm text-muted-foreground">
          Northstar Workflow and both speakers are fictional. Open each passage
          to read the scope and limitations.
        </p>
